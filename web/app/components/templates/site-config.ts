...
export interface SiteConfig {
  ...
  // Examples:
  // - "../SEO Strategy/content" (relative to web/app)
...
export const defaultSiteConfig: SiteConfig = {
  brandName: "AI Closet Stylist",
  brandTagline: "Your entire wardrobe, digitized in minutes",
  resourcesBasePath: "/resources",
  homeUrl: "/",
  contactUrl: "/contact",
  ctaPrimaryText: "Download the App",
  ctaSecondaryText: "View Features",
